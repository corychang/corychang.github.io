...
//$(document).ready(function() {
	...
	var modal3Content = [
		$("<p>This course covers fundamental topics in game programming through the Unity engine. Beyond the labs, we also go over algorithms to solve game programming challenges such as sound simulation and learning behaviors.</p>"),
