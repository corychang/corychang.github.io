...
$(document).ready(function() {
	...
	var modal3Content = [
		...
		$("<p>We began designing the game by looking at the most common calls received by EMTs, which on Carnegie Mellon's campus happens to be ankle injuries and alcohol consumption. We also looked at high risk scenes such seizures or heart attacks due to how important it is to act properly in these scenarios. Afterwards, we performed think aloud testing of practice scenarios with real EMTs to identify problem areas that we should address in our game.</p>"),
